...
function OverlayApp() {
  ...
  return (
    <ThemeProvider>
      ...
      >
        <div className={`flex items-start gap-4 w-full max-w-[700px] lg:max-w-[800px] xl:max-w-[900px] ${isClosing ? 'animate-out fade-out zoom-out-[0.98] slide-out-to-bottom-1 duration-150 ease-in' : 'animate-in fade-in zoom-in-[0.98] slide-in-from-bottom-2 duration-150 ease-out'}`}>
          {/* The Bubble outside the search bar */}
          <div className="hidden sm:flex mt-1 items-center justify-center w-12 h-12 shrink-0 rounded-full bg-white/90 dark:bg-neutral-900/90 backdrop-blur-3xl backdrop-saturate-150 shadow-sm border border-white/60 dark:border-white/10">
